...
const BorderTokenomic = ({ 
    ...
    return (
        <div className="relative xl:aspect-[417/261] ">
            ...
            <div className="flex flex-col xl:gap-4 gap-1 top-[37px] left-[10%] absolute z-10 items-center justify-center xl:w-[75%]">
                {children}
            </div>
        </div>
    );
