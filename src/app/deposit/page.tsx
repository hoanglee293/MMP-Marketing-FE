...
const DepositPage = () => {
    ...
    if (!isAuthenticated) {
        return (
            <div className="flex-1 flex items-center justify-center p-4 z-20">
                <Card className="w-full max-w-md bg-black/60 border-[#d7d7d7]/20 text-white">
                    <CardHeader className="text-center">
                        <CardTitle className="bg-gradient-purple-cyan bg-clip-text text-xl sm:text-2xl font-bold">
                            {t('deposit.connectWalletToDeposit')}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Button
                            onClick={() => setShowConnectModal(true)}
                            className="w-full bg-gradient-violet-blue hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600 text-white font-bold py-2 sm:py-3 text-sm sm:text-base transition-all duration-300 hover:scale-105"
                        >
